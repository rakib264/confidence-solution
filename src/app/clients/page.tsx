...
export const metadata: Metadata = {
  ...
  description:
    "See Confidence Solution LTD.'s trusted partnerships across sovereign, institutional, commercial, and real estate sectors in Saudi Arabia and GCC.",
};
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Our trusted relationships are built on governance discipline, premium quality, and repeatable outcomes."
      ...
      <section className="py-14">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-3xl text-muted-foreground">
            Confidence Solution LTD. supports long-term stakeholder growth with delivery models tailored to each sector’s operational demands, compliance environment, and investment profile.
          </p>
        </div>
      </section>
      <ClientsClient />
